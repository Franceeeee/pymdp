...
class Agent(object):
    ...
    def __init__(
        ...
        self.shared_control_groups = shared_control_groups
    ...
    def _construct_policies(self):
        ...
        policies =  control.construct_policies(
            self.num_states, self.num_controls, self.policy_len, self.control_fac_idx, self.shared_control_groups
        )
